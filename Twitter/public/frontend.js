...
<div data-id="${postData._id}" class=" flex gap-3 hover:bg-[#0f0f0f] transition duration-200 px-4 py-3">
        ...
        <div class="w-full">
            ...
            <!-- USER INFO -->
            <div class=" flex gap-2 items-center m-4 poststemp"  data-id="${postData._id}">
...
async function loadPosts() {
    ...
    profilebtn.addEventListener("click", async()=>{
        ...
        await profilePost(currentUser._id)
...
document.addEventListener("click", (e) => {
    ...
    const posts = e.target.closest(".poststemp")


    profile(posts.dataset.id)
}
)
